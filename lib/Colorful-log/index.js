...
const colorfulLog = (logBy = "", logName = "", ...logData) => console.log(
  ...
  `background: ${index.VUE_DEEP_CYAN}; padding: 6px; border-radius: 1px 0 0 1px;  color: #fff`,
  `background: ${index.VUE_BLUE_GRAY}; padding: 6px; border-radius: 0 1px 1px 0;  color: #fff`,
